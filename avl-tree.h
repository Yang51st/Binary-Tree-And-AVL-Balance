...
private:
    int update_AVLs(Node* temp);
    void Lrot(Node* alphaParent,Node* alpha,Node* A);
    void Rrot(Node* alphaParent,Node* alpha,Node* A);
    void Rection(Node* current, Node* currentParent);
    int gNode(Node* current);
};
